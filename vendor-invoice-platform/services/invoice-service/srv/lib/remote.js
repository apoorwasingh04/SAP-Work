...
// Minimal HTTP client for service-to-service calls (uses Node 18+ global fetch).
// Authenticates as the shared "system" principal (internal scope) via Basic auth.
// In production this would be a client-credentials OAuth token from XSUAA/IAS.
